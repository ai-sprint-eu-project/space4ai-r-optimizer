...
class SystemPE
{
  public:
    ...
    */
    ...
    /** job_mean_times setter */
    template<class T>
    static
    void
    set_mean_times(T&& job_mean_times_)
    {
...
private:
  ...
  private:
    ...
    /** Average execution times of Component-Partition jobs when executed on
    * a given Resource.
    */
    inline
    static
