...
class System
{
  ...
  private:
    ...
    *
    *   \param performance_json json object extracted from configuration_file 
    *                           containing the description of the performance 
    *                           models
    */
    ...
    *
    *   \param demand_matrix_json  nl::json object extracted from 
    *                              configuration_file containing the 
    *                              description of the static performance 
    *                              evaluators
    */
    void initialize_demand_matrix(const nl::json& demand_matrix_json);

  private:
    /** Object containing the data structures that define the System
    *   configuration except for the performance models.
    */
    SystemData system_data;

    /** Object used to store uniqe ptrs to the performance models used by each 
    *   Resource in each Component.
    *
